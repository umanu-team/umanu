...
namespace Framework.BusinessApplications.DataControllers {
    ...
    public abstract class PersistentMasterDetailDataController<T> : MasterDetailDataController<T> where T : PersistentObject, IProvidableObject, new() {
        ...
        public PersistentMasterDetailDataController(PersistentDataProvider<T> dataProvider)
            : base(dataProvider) {
