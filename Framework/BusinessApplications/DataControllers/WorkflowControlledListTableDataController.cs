...
namespace Framework.BusinessApplications.DataControllers {
    ...
    public abstract class WorkflowControlledListTableDataController<T> : PersistentListTableDataController<T> where T : WorkflowControlledObject, new() {

        /// <summary>
        /// Instantiates a new instance.
        /// </summary>
        /// <param name="dataProvider">provider of master/detail data</param>
        public WorkflowControlledListTableDataController(WorkflowControlledDataProvider<T> dataProvider)
            : base(dataProvider) {
            // nothing to do
        }
