...
namespace Framework.BusinessApplications.DataControllers {
    ...
    /// <summary>
    /// Dummy search provider without faceted search view.
    /// </summary>
    /// <typeparam name="T">type of objects to control</typeparam>
    internal sealed class DummySearchController<T> : ISearchController<T> where T : IPresentableObject {
        ...
        public DummySearchController(ISearchProvider<T> searchProvider)
            : base() {
