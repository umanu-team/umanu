...
namespace Framework.BusinessApplications.Interchange.JsonRpc {
    ...
    /// persistent object.
    /// </summary>
    internal class ParametersForInternalContainerNameAndPersistentObject : ParametersForInternalContainerName {
        ...
        /// </summary>
        public ParametersForInternalContainerNameAndPersistentObject()
            : base() {
        ...
        public ParametersForInternalContainerNameAndPersistentObject(string internalContainerName, PersistentObject persistentObject)
            : this() {
