...
namespace Framework.BusinessApplications.Web.Controllers {
    ...
    /// <summary>
    /// Interface for controllers supporting short links.
    /// </summary>
    public interface IShortLinkableController : IHttpController {
        ...
        string FindAbsoluteUrlOfListPageContaining(Guid id);
