...
namespace Framework.BusinessApplications.Web.Controllers {
    ...
    public class JsonSearchController<T> : ListSearchController<T> where T : class, IProvidableObject {
        ...
        public JsonSearchController(IBusinessApplication businessApplication, string absoluteUrl, ListTableDataController<T> listTableDataController, ISearchController<T> searchController)
