...
namespace Framework.BusinessApplications.Web.Controllers {
    ...
    public abstract class ListFileController<T> : FileController where T : class, IProvidableObject {
        ...
        /// dynamic file</param>
        public ListFileController(IBusinessApplication businessApplication, string absoluteUrl, ListTableDataController<T> listTableDataController)
