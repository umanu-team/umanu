...
namespace Framework.BusinessApplications.DataProviders {
    ...
    internal sealed class WizardDataProvider<T> : DataProvider<T> where T : class, IProvidableObject {

        /// <summary>
        /// Page controller to use for wizard.
        /// </summary>
        private readonly WizardController<T> wizardController;
        ...
        /// wizard</param>
        public WizardDataProvider(WizardController<T> wizardController)
            : base() {
        ...
        public override void AddOrUpdate(T element) {
            this.wizardController.UpdatedFormData = element;
            return;
        }
