...
namespace Framework.Presentation.Forms {
    ...
    /// </summary>
    internal sealed class PresentableFieldForEmailPerson : PresentableFieldForElement<IPerson> {
        ...
        public PresentableFieldForEmailPerson(IPresentableObject parentPresentableObject, string key)
        ...
        public PresentableFieldForEmailPerson(IPresentableObject parentPresentableObject, string key, IPerson value)
        ...
        protected override string GetValueAsString() {
            ...
            if (null == this.Value) {
                ...
                value = EmailTemplate.GetMailAddressStringFor(this.Value);
            }
            return value;
        }
            ...
            if (string.IsNullOrEmpty(value)) {
                ...
                try {
                    ...
                    if (string.IsNullOrEmpty(mailAddress.Address)) {
                        ...
                        this.Value = new Person(mailAddress.DisplayName, mailAddress.Address);
                        success = true;
                    }
