...
namespace Framework.Presentation.Forms {
    ...
    /// <summary>
    /// Field for element of type nullable Guid to be presented.
    /// </summary>
    public sealed class PresentableFieldForNullableGuid : PresentableFieldForElement<Guid?> {
        ...
        public PresentableFieldForNullableGuid(IPresentableObject parentPresentableObject, string key)
        ...
        public PresentableFieldForNullableGuid(IPresentableObject parentPresentableObject, string key, Guid? value)
        ...
        protected override string GetValueAsString() {
            ...
            if (this.Value.HasValue) {
                value = this.Value.Value.ToString("N");
            } else {
                value = string.Empty;
            }
            return value;
        ...
        public override bool TrySetValueAsString(string value) {
            ...
            if (string.IsNullOrEmpty(value)) {
                ...
                success = Guid.TryParse(value, out Guid parsedValue);
