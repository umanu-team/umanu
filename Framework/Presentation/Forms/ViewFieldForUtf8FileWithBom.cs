...
namespace Framework.Presentation.Forms {
    ...
    /// <summary>
    /// Field for single UTF-8 file with BOM to be presented in a
    /// view.
    /// </summary>
    public class ViewFieldForUtf8FileWithBom : ViewFieldForFile {

        /// <summary>
        /// Instantiates a new instance.
        /// </summary>
        public ViewFieldForUtf8FileWithBom()
            : base() {
            // nothing to do
        }
        ...
        public ViewFieldForUtf8FileWithBom(string title, string key, Mandatoriness mandatoriness)
        ...
        /// <param name="mandatoriness">value indicating whether a
        /// value in this field is required</param>
        public ViewFieldForUtf8FileWithBom(string title, string[] keyChain, Mandatoriness mandatoriness)
        ...
        public override string Validate(IPresentableFieldForElement presentableField, ValidityCheck validityCheck, IPresentableObject presentableObject, IOptionDataProvider optionDataProvider) {
            ...
            if (string.IsNullOrEmpty(errorMessage) && presentableField.ValueAsObject is File file && !file.HasUtf8Bom) {
                errorMessage = Resources.PleaseSelectACsvFileEndodedAsUtf8WithBom;
            }
            return errorMessage;
        }
