...
namespace Framework.Presentation.Forms {
    ...
    /// </summary>
    public class ViewFieldForPresentableObjectChoice : ViewFieldForChoice, IClickableViewFieldWithOptionProvider {
        ...
        /// </summary>
        public ViewFieldForPresentableObjectChoice()
            : base() {
            // nothing to do
        }
        ...
        public ViewFieldForPresentableObjectChoice(string title, string key, Mandatoriness mandatoriness)
        ...
        /// <param name="mandatoriness">value indicating whether a
        /// value in this field is required</param>
        public ViewFieldForPresentableObjectChoice(string title, string[] keyChain, Mandatoriness mandatoriness)
            : this(title, mandatoriness) {
        ...
        /// <param name="mandatoriness">value indicating whether a
        /// value in this field is required</param>
        private ViewFieldForPresentableObjectChoice(string title, Mandatoriness mandatoriness)
            : this() {
