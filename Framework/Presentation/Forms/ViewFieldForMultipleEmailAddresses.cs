...
namespace Framework.Presentation.Forms {
    ...
    /// <summary>
    /// Field for multiple e-mail addresses to be presented in a view.
    /// </summary>
    public class ViewFieldForMultipleEmailAddresses : ViewFieldForMultipleSingleLineTexts {

        /// <summary>
        /// Instantiates a new instance.
        /// </summary>
        public ViewFieldForMultipleEmailAddresses()
            : base() {
            // nothing to do
        }
        ...
        public ViewFieldForMultipleEmailAddresses(string title, string key, Mandatoriness mandatoriness)
        ...
        /// <param name="mandatoriness">value indicating whether a
        /// value in this field is required</param>
        public ViewFieldForMultipleEmailAddresses(string title, string[] keyChain, Mandatoriness mandatoriness)
        ...
        public override string Validate(IPresentableFieldForCollection presentableField, ValidityCheck validityCheck, IPresentableObject presentableObject, IOptionDataProvider optionDataProvider) {
            var viewFieldForElement = new ViewFieldForEmailAddress(this.Key, this.Title, Mandatoriness.Optional);
