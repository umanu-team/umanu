...
namespace Framework.Presentation.Forms {
    ...
    /// <summary>
    /// Field for multiple urls to be presented in a view.
    /// </summary>
    public class ViewFieldForMultipleUrls : ViewFieldForMultipleSingleLineTexts {

        /// <summary>
        /// Instantiates a new instance.
        /// </summary>
        public ViewFieldForMultipleUrls()
            : base() {
            // nothing to do
        }
        ...
        public ViewFieldForMultipleUrls(string title, string key, Mandatoriness mandatoriness)
        ...
        /// <param name="mandatoriness">value indicating whether a
        /// value in this field is required</param>
        public ViewFieldForMultipleUrls(string title, string[] keyChain, Mandatoriness mandatoriness)
        ...
        public override string Validate(IPresentableFieldForCollection presentableField, ValidityCheck validityCheck, IPresentableObject presentableObject, IOptionDataProvider optionDataProvider) {
            var viewFieldForElement = new ViewFieldForUrl(this.Key, this.Title, Mandatoriness.Optional);
