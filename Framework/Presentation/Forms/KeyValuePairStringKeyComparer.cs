...
namespace Framework.Presentation.Forms {
    ...
    /// <summary>
    /// Compares key/value pairs of type string/string by key.
    /// </summary>
    internal sealed class KeyValuePairStringKeyComparer : IComparer<KeyValuePair<string, string>> {

        /// <summary>
        /// Instantiates a new instance.
        /// </summary>
        public KeyValuePairStringKeyComparer() {
            // nothing to do
        }
