...
namespace Framework.Presentation.Forms {
    ...
    /// <summary>
    /// Field for an e-mail address to be presented in a view.
    /// </summary>
    public class ViewFieldForEmailAddress : ViewFieldForSingleLineText {

        /// <summary>
        /// Instantiates a new instance.
        /// </summary>
        public ViewFieldForEmailAddress()
            : base() {
            // nothing to do
        }
        ...
        public ViewFieldForEmailAddress(string title, string key, Mandatoriness mandatoriness)
        ...
        /// <param name="mandatoriness">value indicating whether a
        /// value in this field is required</param>
        public ViewFieldForEmailAddress(string title, string[] keyChain, Mandatoriness mandatoriness)
        ...
        public override string Validate(IPresentableFieldForElement presentableField, ValidityCheck validityCheck, IPresentableObject presentableObject, IOptionDataProvider optionDataProvider) {
            ...
            if (string.IsNullOrEmpty(errorMessage) && !string.IsNullOrEmpty(value)) {
                if (!Regex.ForStandAloneEmailAddress.IsMatch(value)) {
