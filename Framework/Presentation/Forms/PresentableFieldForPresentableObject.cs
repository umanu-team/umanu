...
namespace Framework.Presentation.Forms {
    ...
    /// <summary>
    /// Field of presentable object to be presented.
    /// </summary>
    /// <typeparam name="T">type of value</typeparam>
    public sealed class PresentableFieldForPresentableObject<T> : PresentableFieldForElement<T> where T : IPresentableObject {
        ...
        public PresentableFieldForPresentableObject(IPresentableObject parentPresentableObject, string key)
        ...
        public PresentableFieldForPresentableObject(IPresentableObject parentPresentableObject, string key, T value)
            : base(parentPresentableObject, key) {
            this.Value = value;
        }
