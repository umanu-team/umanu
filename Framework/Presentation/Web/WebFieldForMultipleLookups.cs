...
namespace Framework.Presentation.Web {
    ...
    /// <summary>
    /// Field control for multiple lookup values.
    /// </summary>
    public abstract class WebFieldForMultipleLookups : WebFieldForCollection {

        /// <summary>
        /// View field to build control for.
        /// </summary>
        private ViewFieldForMultipleLookups viewField;
        ...
        /// form</param>
        public WebFieldForMultipleLookups(IPresentableFieldForCollection presentableField, ViewFieldForMultipleLookups viewField, FieldRenderMode renderMode, IPresentableObject topmostParentPresentableObject, IOptionDataProvider optionDataProvider, DateTime? comparisonDate, string clientFieldIdPrefix, string clientFieldIdSuffix, PostBackState postBackState)
            ...
            if (this.viewField.Limit < 2) {
                ...
                foreach (string editableValue in this.GetEditableValues()) {
                    if (null != editableValue) {
                        ...
                        html.AppendHtmlEncoded(editableValue);
                    }
                }
