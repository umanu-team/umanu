...
namespace Framework.Presentation.Web {
    ...
    /// <summary>
    /// Field control for a color.
    /// </summary>
    public class WebFieldForColor : WebFieldForElement {

        /// <summary>
        /// View field to build control for.
        /// </summary>
        public ViewFieldForColor ViewField { get; private set; }
        ...
        /// form</param>
        public WebFieldForColor(IPresentableFieldForElement presentableField, ViewFieldForColor viewField, FieldRenderMode renderMode, IPresentableObject topmostParentPresentableObject, IOptionDataProvider optionDataProvider, DateTime? comparisonDate, string clientFieldIdPrefix, string clientFieldIdSuffix, PostBackState postBackState)
        ...
        protected override void RenderReadOnlyValue(HtmlWriter html) {
            string currentValue = this.GetReadOnlyValue();
            bool isDiffNew;
            if (this.ComparisonDate.HasValue) {
                ...
                if (isDiffNew && !string.IsNullOrEmpty(comparativeValue)) {
                    ...
                    html.AppendOpeningTag("span", new KeyValuePair<string, string>("style", "background-color:" + currentValue + ";color:" + currentValue + ";"));
