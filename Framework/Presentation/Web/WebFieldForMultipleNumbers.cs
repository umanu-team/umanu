...
namespace Framework.Presentation.Web {
    ...
    /// <summary>
    /// Field control for multiple numbers.
    /// </summary>
    public class WebFieldForMultipleNumbers : WebFieldForCollection {

        /// <summary>
        /// View field to build control for.
        /// </summary>
        public ViewFieldForMultipleNumbers ViewField { get; private set; }
        ...
        /// form</param>
        public WebFieldForMultipleNumbers(IPresentableFieldForCollection presentableField, ViewFieldForMultipleNumbers viewField, FieldRenderMode renderMode, IPresentableObject topmostParentPresentableObject, IOptionDataProvider optionDataProvider, DateTime? comparisonDate, string clientFieldIdPrefix, string clientFieldIdSuffix, PostBackState postBackState)
        ...
        protected override void RenderEditableValue(HtmlWriter html) {
            ...
            attributes.Add("type", "text"); // HACK: Work around for buggy webshim polyfill.js, which does not support input fields for multiple numbers.
