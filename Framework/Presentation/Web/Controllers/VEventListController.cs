...
namespace Framework.Presentation.Web.Controllers {
    ...
    /// iCalendar files.
    /// </summary>
    public abstract class VEventListController : FileController {
        ...
        public VEventListController(string absoluteUrl)
        ...
        protected abstract IEnumerable<IProvidableObject> FindEvents();
        ...
        protected sealed override File FindFile(Uri url) {
            ...
            if (url.AbsolutePath == this.AbsoluteUrl) {
                var iCalendar = new VEventListWriter(this.GetView(), this.FindEvents());
        ...
        /// <summary>
        /// Gets the event list view to be applied for field mapping.
        /// </summary>
        /// <returns>event list view to be applied for field mapping</returns>
        protected abstract VEventListView GetView();
