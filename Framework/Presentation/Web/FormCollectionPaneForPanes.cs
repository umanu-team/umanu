...
namespace Framework.Presentation.Web {
    ...
    /// <summary>
    /// Control for rendering panes of multiple objects in a
    /// container - the user can switch between the objects.
    /// </summary>
    public class FormCollectionPaneForPanes : FormCollectionPane<ViewCollectionPaneForPanes> {
        ...
        /// controls</param>
        public FormCollectionPaneForPanes(IPresentableObject presentableObject, ViewCollectionPaneForPanes viewPane, IPresentableObject topmostParentPresentableObject, DateTime? comparisonDate, string clientFieldIdPrefix, string clientFieldIdSuffix, PostBackState postBackState, string fileBaseDirectory, WebFactory formFactory)
