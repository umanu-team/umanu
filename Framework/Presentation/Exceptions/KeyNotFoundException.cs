...
namespace Framework.Presentation.Exceptions {

    using System;

    /// <summary>
    /// Exception class for key not found errors in presentation
    /// layer.
    /// </summary>
    [Serializable]
    public class KeyNotFoundException : PresentationException {
