...
namespace Framework.Persistence.SecurableObjects {
    ...
    /// <summary>
    /// Encapsulated string values with allowed groups.
    /// </summary>
    public sealed class StringCollectionWithAllowedGroups : PersistentObject {
        ...
        /// </summary>
        public StringCollectionWithAllowedGroups()
            : base() {
