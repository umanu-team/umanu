...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// Wrapper class for a field of type sbyte to be stored in
    /// persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForSByte : PersistentFieldForStruct<sbyte> {
        ...
        public PersistentFieldForSByte(string key)
            : base(key) {
            // nothing to do
        }
        ...
        public PersistentFieldForSByte(string key, sbyte value)
            : this(key) {
            this.Value = value;
        }
        ...
        internal override void LoadValueFromDbDataReader(DbDataReader dataReader, int ordinal) {
            if (dataReader.IsDBNull(ordinal)) {
                this.valueFromDbDataReader = default(sbyte);
            } else {
