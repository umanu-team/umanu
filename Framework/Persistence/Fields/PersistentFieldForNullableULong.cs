...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// Wrapper class for a field of type nullable ulong to be stored
    /// in persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForNullableULong : PersistentFieldForElement<ulong?> {
        ...
        /// </summary>
        private ulong? valueFromDbDataReader;

        /// <summary>
        /// Instantiates a new instance.
        /// </summary>
        /// <param name="key">name of persistent field</param>
        public PersistentFieldForNullableULong(string key)
            : base(key) {
            // nothing to do
        }
        ...
        public PersistentFieldForNullableULong(string key, ulong? value)
            : this(key) {
            this.Value = value;
        }
        ...
        internal override void LoadValueFromDbDataReader(DbDataReader dataReader, int ordinal) {
            if (dataReader.IsDBNull(ordinal)) {
                ...
                this.valueFromDbDataReader = Convert.ToUInt64(dataReader.GetValue(ordinal), CultureInfo.InvariantCulture.NumberFormat);
            }
            return;
        }
        ...
        public override bool TrySetValueAsString(string value) {
            ...
            if (string.IsNullOrEmpty(value)) {
                ...
                success = ulong.TryParse(value, NumberStyles.Any, CultureInfo.InvariantCulture, out ulong parsedValue);
        ...
        protected override bool ValuesAreDifferent(ulong? x, ulong? y) {
            return !x.Equals(y);
        }
