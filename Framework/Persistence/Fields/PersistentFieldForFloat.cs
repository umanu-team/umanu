...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// Wrapper class for a field of type float to be stored in
    /// persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForFloat : PersistentFieldForStruct<float> {
        ...
        public PersistentFieldForFloat(string key)
            : base(key) {
            // nothing to do
        }
        ...
        public PersistentFieldForFloat(string key, float value)
            : this(key) {
            this.Value = value;
        }
        ...
        internal override void LoadValueFromDbDataReader(DbDataReader dataReader, int ordinal) {
            if (dataReader.IsDBNull(ordinal)) {
                this.valueFromDbDataReader = default(float);
            } else {
