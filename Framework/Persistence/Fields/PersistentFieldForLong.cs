...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// Wrapper class for a field of type long to be stored in
    /// persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForLong : PersistentFieldForStruct<long> {
        ...
        public PersistentFieldForLong(string key)
            : base(key) {
            // nothing to do
        }
        ...
        public PersistentFieldForLong(string key, long value)
            : this(key) {
            this.Value = value;
        }
        ...
        internal override void LoadValueFromDbDataReader(DbDataReader dataReader, int ordinal) {
            if (dataReader.IsDBNull(ordinal)) {
                this.valueFromDbDataReader = default(long);
            } else {
