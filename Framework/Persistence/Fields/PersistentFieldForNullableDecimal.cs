...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// Wrapper class for a field of type nullable decimal to be
    /// stored in persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForNullableDecimal : PersistentFieldForElement<decimal?> {
        ...
        /// </summary>
        private decimal? valueFromDbDataReader;

        /// <summary>
        /// Instantiates a new instance.
        /// </summary>
        /// <param name="key">name of persistent field</param>
        public PersistentFieldForNullableDecimal(string key)
            : base(key) {
            // nothing to do
        }
        ...
        public PersistentFieldForNullableDecimal(string key, decimal? value)
            : this(key) {
            this.Value = value;
        }
        ...
        internal override void LoadValueFromDbDataReader(DbDataReader dataReader, int ordinal) {
            if (dataReader.IsDBNull(ordinal)) {
                ...
                if (this.ParentPersistentObject.ParentPersistentContainer.ParentPersistenceMechanism.HasNativeSupportForDecimal) {
                    this.valueFromDbDataReader = dataReader.GetDecimal(ordinal);
                } else {
                    this.valueFromDbDataReader = Convert.ToDecimal(dataReader.GetValue(ordinal), CultureInfo.InvariantCulture.NumberFormat);
                }
            }
            return;
        }
        ...
        public override bool TrySetValueAsString(string value) {
            ...
            if (string.IsNullOrEmpty(value)) {
                ...
                success = decimal.TryParse(value, NumberStyles.Any, CultureInfo.InvariantCulture, out decimal parsedValue);
        ...
        protected override bool ValuesAreDifferent(decimal? x, decimal? y) {
            return !x.Equals(y);
        }
