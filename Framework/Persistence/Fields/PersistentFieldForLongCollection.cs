...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// List of objects of type long that can be stored in
    /// persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForLongCollection : PersistentFieldForCollection<long> {
        ...
        /// </summary>
        private List<long> valuesFromDbDataReader;

        /// <summary>
        /// Instantiates a new instance.
        /// </summary>
        /// <param name="key">name of persistent field</param>
        public PersistentFieldForLongCollection(string key)
            : base(key) {
            // nothing to do
        }
        ...
        protected override PersistentFieldForElement<long> GetNewPersistentFieldForElement() {
            return new PersistentFieldForLong(this.Key);
        }
        ...
        internal override void InitializeTemporaryCollectionForDbDataReader() {
            this.valuesFromDbDataReader = new List<long>();
            return;
        }
        ...
        internal override void LoadValueFromDbDataReader(DbDataReader dataReader) {
            this.valuesFromDbDataReader.Add(dataReader.GetInt64(0));
            return;
        }
        ...
        public override bool TryAddString(string item) {
            bool success = long.TryParse(item, NumberStyles.Any, CultureInfo.InvariantCulture, out long parsedItem);
            this.Add(parsedItem);
            return success;
        }
