...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// Wrapper class for a field of type nullable float to be stored
    /// in persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForNullableFloat : PersistentFieldForElement<float?> {
        ...
        /// </summary>
        private float? valueFromDbDataReader;

        /// <summary>
        /// Instantiates a new instance.
        /// </summary>
        /// <param name="key">name of persistent field</param>
        public PersistentFieldForNullableFloat(string key)
            : base(key) {
            // nothing to do
        }
        ...
        public PersistentFieldForNullableFloat(string key, float? value)
            : this(key) {
            this.Value = value;
        }
        ...
        internal override void LoadValueFromDbDataReader(DbDataReader dataReader, int ordinal) {
            if (dataReader.IsDBNull(ordinal)) {
                ...
                this.valueFromDbDataReader = dataReader.GetFloat(ordinal);
            }
            return;
        }
        ...
        public override bool TrySetValueAsString(string value) {
            ...
            if (string.IsNullOrEmpty(value)) {
                ...
                success = float.TryParse(value, NumberStyles.Any, CultureInfo.InvariantCulture, out float parsedValue);
        ...
        protected override bool ValuesAreDifferent(float? x, float? y) {
            return !x.Equals(y);
        }
