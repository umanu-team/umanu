...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// Wrapper class for a field of type nullable long to be stored
    /// in persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForNullableLong : PersistentFieldForElement<long?> {
        ...
        /// </summary>
        private long? valueFromDbDataReader;

        /// <summary>
        /// Instantiates a new instance.
        /// </summary>
        /// <param name="key">name of persistent field</param>
        public PersistentFieldForNullableLong(string key)
            : base(key) {
            // nothing to do
        }
        ...
        public PersistentFieldForNullableLong(string key, long? value)
            : this(key) {
            this.Value = value;
        }
        ...
        internal override void LoadValueFromDbDataReader(DbDataReader dataReader, int ordinal) {
            if (dataReader.IsDBNull(ordinal)) {
                ...
                this.valueFromDbDataReader = dataReader.GetInt64(ordinal);
            }
            return;
        }
        ...
        public override bool TrySetValueAsString(string value) {
            ...
            if (string.IsNullOrEmpty(value)) {
                ...
                success = long.TryParse(value, NumberStyles.Any, CultureInfo.InvariantCulture, out long parsedValue);
        ...
        protected override bool ValuesAreDifferent(long? x, long? y) {
            return !x.Equals(y);
        }
