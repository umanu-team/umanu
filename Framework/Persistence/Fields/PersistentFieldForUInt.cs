...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// Wrapper class for a field of type uint to be stored in
    /// persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForUInt : PersistentFieldForStruct<uint> {
        ...
        public PersistentFieldForUInt(string key)
            : base(key) {
            // nothing to do
        }
        ...
        public PersistentFieldForUInt(string key, uint value)
            : this(key) {
            this.Value = value;
        }
        ...
        internal override void LoadValueFromDbDataReader(DbDataReader dataReader, int ordinal) {
            if (dataReader.IsDBNull(ordinal)) {
                this.valueFromDbDataReader = default(uint);
            } else {
