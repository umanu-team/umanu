...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// List of objects of type ushort that can be stored in
    /// persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForUShortCollection : PersistentFieldForCollection<ushort> {
        ...
        /// </summary>
        private List<ushort> valuesFromDbDataReader;

        /// <summary>
        /// Instantiates a new instance.
        /// </summary>
        /// <param name="key">name of persistent field</param>
        public PersistentFieldForUShortCollection(string key)
            : base(key) {
            // nothing to do
        }
        ...
        protected override PersistentFieldForElement<ushort> GetNewPersistentFieldForElement() {
            return new PersistentFieldForUShort(this.Key);
        }
        ...
        public override IEnumerable<string> GetValuesAsString() {
            foreach (var uShortValue in this) {
                yield return uShortValue.ToString(CultureInfo.InvariantCulture);
            }
        }
        ...
        internal override void InitializeTemporaryCollectionForDbDataReader() {
            this.valuesFromDbDataReader = new List<ushort>();
            return;
        }
        ...
        internal override void LoadValueFromDbDataReader(DbDataReader dataReader) {
            this.valuesFromDbDataReader.Add(Convert.ToUInt16(dataReader.GetValue(0), CultureInfo.InvariantCulture.NumberFormat));
            return;
        }
        ...
        public override bool TryAddString(string item) {
            bool success = ushort.TryParse(item, NumberStyles.Any, CultureInfo.InvariantCulture, out ushort parsedItem);
            this.Add(parsedItem);
            return success;
        }
