...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// Wrapper class for a field of type nullable uint to be stored
    /// in persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForNullableUInt : PersistentFieldForElement<uint?> {
        ...
        /// </summary>
        private uint? valueFromDbDataReader;

        /// <summary>
        /// Instantiates a new instance.
        /// </summary>
        /// <param name="key">name of persistent field</param>
        public PersistentFieldForNullableUInt(string key)
            : base(key) {
            // nothing to do
        }
        ...
        public PersistentFieldForNullableUInt(string key, uint? value)
            : this(key) {
            this.Value = value;
        }
        ...
        internal override void LoadValueFromDbDataReader(DbDataReader dataReader, int ordinal) {
            if (dataReader.IsDBNull(ordinal)) {
                ...
                this.valueFromDbDataReader = Convert.ToUInt32(dataReader.GetValue(ordinal), CultureInfo.InvariantCulture.NumberFormat);
            }
            return;
        }
        ...
        public override bool TrySetValueAsString(string value) {
            ...
            if (string.IsNullOrEmpty(value)) {
                ...
                success = uint.TryParse(value, NumberStyles.Any, CultureInfo.InvariantCulture, out uint parsedValue);
        ...
        protected override bool ValuesAreDifferent(uint? x, uint? y) {
            return !x.Equals(y);
        }
