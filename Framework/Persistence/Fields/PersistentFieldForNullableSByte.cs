...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// Wrapper class for a field of type nullable sbyte to be stored
    /// in persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForNullableSByte : PersistentFieldForElement<sbyte?> {
        ...
        /// </summary>
        private sbyte? valueFromDbDataReader;

        /// <summary>
        /// Instantiates a new instance.
        /// </summary>
        /// <param name="key">name of persistent field</param>
        public PersistentFieldForNullableSByte(string key)
            : base(key) {
            // nothing to do
        }
        ...
        public PersistentFieldForNullableSByte(string key, sbyte? value)
            : this(key) {
            this.Value = value;
        }
        ...
        internal override void LoadValueFromDbDataReader(DbDataReader dataReader, int ordinal) {
            if (dataReader.IsDBNull(ordinal)) {
                ...
                this.valueFromDbDataReader = Convert.ToSByte(dataReader.GetValue(ordinal), CultureInfo.InvariantCulture.NumberFormat);
            }
            return;
        }
        ...
        public override bool TrySetValueAsString(string value) {
            ...
            if (string.IsNullOrEmpty(value)) {
                ...
                success = sbyte.TryParse(value, NumberStyles.Any, CultureInfo.InvariantCulture, out sbyte parsedValue);
        ...
        protected override bool ValuesAreDifferent(sbyte? x, sbyte? y) {
            return !x.Equals(y);
        }
