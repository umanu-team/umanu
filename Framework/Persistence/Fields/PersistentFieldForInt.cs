...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// Wrapper class for a field of type int to be stored in
    /// persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForInt : PersistentFieldForStruct<int> {
        ...
        public PersistentFieldForInt(string key)
            : base(key) {
            // nothing to do
        }
        ...
        public PersistentFieldForInt(string key, int value)
            : this(key) {
            this.Value = value;
        }
        ...
        internal override void LoadValueFromDbDataReader(DbDataReader dataReader, int ordinal) {
            if (dataReader.IsDBNull(ordinal)) {
                this.valueFromDbDataReader = default(int);
            } else {
