...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// Wrapper class for a field of type short to be stored in
    /// persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForShort : PersistentFieldForStruct<short> {
        ...
        public PersistentFieldForShort(string key)
            : base(key) {
            // nothing to do
        }
        ...
        public PersistentFieldForShort(string key, short value)
            : this(key) {
            this.Value = value;
        }
        ...
        internal override void LoadValueFromDbDataReader(DbDataReader dataReader, int ordinal) {
            if (dataReader.IsDBNull(ordinal)) {
                this.valueFromDbDataReader = default(short);
            } else {
