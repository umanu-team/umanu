...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// Wrapper class for a field of type nullable int to be stored
    /// in persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForNullableInt : PersistentFieldForElement<int?> {
        ...
        /// </summary>
        private int? valueFromDbDataReader;

        /// <summary>
        /// Instantiates a new instance.
        /// </summary>
        /// <param name="key">name of persistent field</param>
        public PersistentFieldForNullableInt(string key)
            : base(key) {
            // nothing to do
        }
        ...
        public PersistentFieldForNullableInt(string key, int? value)
            : this(key) {
            this.Value = value;
        }
        ...
        internal override void LoadValueFromDbDataReader(DbDataReader dataReader, int ordinal) {
            if (dataReader.IsDBNull(ordinal)) {
                ...
                this.valueFromDbDataReader = dataReader.GetInt32(ordinal);
            }
            return;
        }
        ...
        public override bool TrySetValueAsString(string value) {
            ...
            if (string.IsNullOrEmpty(value)) {
                ...
                success = int.TryParse(value, NumberStyles.Any, CultureInfo.InvariantCulture, out int parsedValue);
        ...
        protected override bool ValuesAreDifferent(int? x, int? y) {
            return !x.Equals(y);
        }
