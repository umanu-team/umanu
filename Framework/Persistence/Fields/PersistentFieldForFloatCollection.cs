...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// List of objects of type float that can be stored in
    /// persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForFloatCollection : PersistentFieldForCollection<float> {
        ...
        /// </summary>
        private List<float> valuesFromDbDataReader;

        /// <summary>
        /// Instantiates a new instance.
        /// </summary>
        /// <param name="key">name of persistent field</param>
        public PersistentFieldForFloatCollection(string key)
            : base(key) {
            // nothing to do
        }
        ...
        protected override PersistentFieldForElement<float> GetNewPersistentFieldForElement() {
            return new PersistentFieldForFloat(this.Key);
        }
        ...
        public override IEnumerable<string> GetValuesAsString() {
            foreach (var floatValue in this) {
                yield return floatValue.ToString(CultureInfo.InvariantCulture);
            }
        }
        ...
        internal override void InitializeTemporaryCollectionForDbDataReader() {
            this.valuesFromDbDataReader = new List<float>();
            return;
        }
        ...
        internal override void LoadValueFromDbDataReader(DbDataReader dataReader) {
            this.valuesFromDbDataReader.Add(dataReader.GetFloat(0));
            return;
        }
        ...
        public override bool TryAddString(string item) {
            bool success = float.TryParse(item, NumberStyles.Any, CultureInfo.InvariantCulture, out float parsedItem);
            this.Add(parsedItem);
            return success;
        }
