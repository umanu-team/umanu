...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// List of objects of type int that can be stored in
    /// persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForIntCollection : PersistentFieldForCollection<int> {
        ...
        /// </summary>
        private List<int> valuesFromDbDataReader;

        /// <summary>
        /// Instantiates a new instance.
        /// </summary>
        /// <param name="key">name of persistent field</param>
        public PersistentFieldForIntCollection(string key)
            : base(key) {
            // nothing to do
        }
        ...
        protected override PersistentFieldForElement<int> GetNewPersistentFieldForElement() {
            return new PersistentFieldForInt(this.Key);
        }
        ...
        internal override void InitializeTemporaryCollectionForDbDataReader() {
            this.valuesFromDbDataReader = new List<int>();
            return;
        }
        ...
        internal override void LoadValueFromDbDataReader(DbDataReader dataReader) {
            this.valuesFromDbDataReader.Add(dataReader.GetInt32(0));
            return;
        }
        ...
        public override bool TryAddString(string item) {
            bool success = int.TryParse(item, NumberStyles.Any, CultureInfo.InvariantCulture, out int parsedItem);
            this.Add(parsedItem);
            return success;
        }
