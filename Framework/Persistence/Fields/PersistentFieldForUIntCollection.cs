...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// List of objects of type uint that can be stored in
    /// persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForUIntCollection : PersistentFieldForCollection<uint> {
        ...
        /// </summary>
        private List<uint> valuesFromDbDataReader;

        /// <summary>
        /// Instantiates a new instance.
        /// </summary>
        /// <param name="key">name of persistent field</param>
        public PersistentFieldForUIntCollection(string key)
            : base(key) {
            // nothing to do
        }
        ...
        protected override PersistentFieldForElement<uint> GetNewPersistentFieldForElement() {
            return new PersistentFieldForUInt(this.Key);
        }
        ...
        public override IEnumerable<string> GetValuesAsString() {
            foreach (var uIntValue in this) {
                yield return uIntValue.ToString(CultureInfo.InvariantCulture);
            }
        }
        ...
        internal override void InitializeTemporaryCollectionForDbDataReader() {
            this.valuesFromDbDataReader = new List<uint>();
            return;
        }
        ...
        internal override void LoadValueFromDbDataReader(DbDataReader dataReader) {
            this.valuesFromDbDataReader.Add(Convert.ToUInt32(dataReader.GetValue(0), CultureInfo.InvariantCulture.NumberFormat));
            return;
        }
        ...
        public override bool TryAddString(string item) {
            bool success = uint.TryParse(item, NumberStyles.Any, CultureInfo.InvariantCulture, out uint parsedItem);
            this.Add(parsedItem);
            return success;
        }
