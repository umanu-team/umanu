...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// Wrapper class for a field of type nullable double to be
    /// stored in persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForNullableDouble : PersistentFieldForElement<double?> {
        ...
        /// </summary>
        private double? valueFromDbDataReader;

        /// <summary>
        /// Instantiates a new instance.
        /// </summary>
        /// <param name="key">name of persistent field</param>
        public PersistentFieldForNullableDouble(string key)
            : base(key) {
            // nothing to do
        }
        ...
        public PersistentFieldForNullableDouble(string key, double? value)
            : this(key) {
            this.Value = value;
        }
        ...
        internal override void LoadValueFromDbDataReader(DbDataReader dataReader, int ordinal) {
            if (dataReader.IsDBNull(ordinal)) {
                ...
                this.valueFromDbDataReader = dataReader.GetDouble(ordinal);
            }
            return;
        }
        ...
        public override bool TrySetValueAsString(string value) {
            ...
            if (string.IsNullOrEmpty(value)) {
                ...
                success = double.TryParse(value, NumberStyles.Any, CultureInfo.InvariantCulture, out double parsedValue);
        ...
        protected override bool ValuesAreDifferent(double? x, double? y) {
            return !x.Equals(y);
        }
