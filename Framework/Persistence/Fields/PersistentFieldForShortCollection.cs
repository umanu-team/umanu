...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// List of objects of type short that can be stored in
    /// persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForShortCollection : PersistentFieldForCollection<short> {
        ...
        /// </summary>
        private List<short> valuesFromDbDataReader;

        /// <summary>
        /// Instantiates a new instance.
        /// </summary>
        /// <param name="key">name of persistent field</param>
        public PersistentFieldForShortCollection(string key)
            : base(key) {
            // nothing to do
        }
        ...
        protected override PersistentFieldForElement<short> GetNewPersistentFieldForElement() {
            return new PersistentFieldForShort(this.Key);
        }
        ...
        public override IEnumerable<string> GetValuesAsString() {
            foreach (var shortValue in this) {
        ...
        internal override void InitializeTemporaryCollectionForDbDataReader() {
            this.valuesFromDbDataReader = new List<short>();
            return;
        }
        ...
        internal override void LoadValueFromDbDataReader(DbDataReader dataReader) {
            this.valuesFromDbDataReader.Add(dataReader.GetInt16(0));
            return;
        }
        ...
        public override bool TryAddString(string item) {
            bool success = short.TryParse(item, NumberStyles.Any, CultureInfo.InvariantCulture, out short parsedItem);
            this.Add(parsedItem);
            return success;
        }
