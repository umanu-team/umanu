...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// Wrapper class for a field of type nullable char to be stored
    /// in persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForNullableChar : PersistentFieldForElement<char?> {
        ...
        /// </summary>
        private char? valueFromDbDataReader;

        /// <summary>
        /// Instantiates a new instance.
        /// </summary>
        /// <param name="key">name of persistent field</param>
        public PersistentFieldForNullableChar(string key)
            : base(key) {
            // nothing to do
        }
        ...
        public PersistentFieldForNullableChar(string key, char? value)
            : this(key) {
            this.Value = value;
        }
        ...
        internal override void LoadValueFromDbDataReader(DbDataReader dataReader, int ordinal) {
            if (dataReader.IsDBNull(ordinal)) {
                ...
                string value = dataReader.GetString(ordinal);
                if (value.Length > 0) {
                    this.valueFromDbDataReader = value[0];
                } else {
                    this.valueFromDbDataReader = default(char);
                }
            }
            return;
        }
        ...
        public override bool TrySetValueAsString(string value) {
            ...
            if (string.IsNullOrEmpty(value)) {
                ...
                success = char.TryParse(value, out char parsedValue);
        ...
        protected override bool ValuesAreDifferent(char? x, char? y) {
            return !x.Equals(y);
        }
