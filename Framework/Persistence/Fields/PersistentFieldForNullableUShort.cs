...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// Wrapper class for a field of type nullable ushort to be
    /// stored in persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForNullableUShort : PersistentFieldForElement<ushort?> {
        ...
        /// </summary>
        private ushort? valueFromDbDataReader;

        /// <summary>
        /// Instantiates a new instance.
        /// </summary>
        /// <param name="key">name of persistent field</param>
        public PersistentFieldForNullableUShort(string key)
            : base(key) {
            // nothing to do
        }
        ...
        public PersistentFieldForNullableUShort(string key, ushort? value)
            : this(key) {
            this.Value = value;
        }
        ...
        internal override void LoadValueFromDbDataReader(DbDataReader dataReader, int ordinal) {
            if (dataReader.IsDBNull(ordinal)) {
                ...
                this.valueFromDbDataReader = Convert.ToUInt16(dataReader.GetValue(ordinal), CultureInfo.InvariantCulture.NumberFormat);
            }
            return;
        }
        ...
        public override bool TrySetValueAsString(string value) {
            ...
            if (string.IsNullOrEmpty(value)) {
                ...
                success = ushort.TryParse(value, out ushort parsedValue);
        ...
        protected override bool ValuesAreDifferent(ushort? x, ushort? y) {
            return !x.Equals(y);
        }
