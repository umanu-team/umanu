...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// Wrapper class for a field of type DateTime to be stored in
    /// persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForNullableDateTime : PersistentFieldForElement<DateTime?> {
        ...
        public override Type ContentBaseType {
            get {
                return TypeOf.NullableDateTime;
            }
        }
        ...
        /// </summary>
        private DateTime? valueFromDbDataReader;

        /// <summary>
        /// Instantiates a new instance.
        /// </summary>
        /// <param name="key">name of persistent field</param>
        public PersistentFieldForNullableDateTime(string key)
            : base(key) {
            // nothing to do
        }
        ...
        public PersistentFieldForNullableDateTime(string key, DateTime? value)
            : this(key) {
            this.Value = value;
        }
        ...
        protected internal override string GetValueAsString() {
            string value;
            if (this.Value.HasValue) {
                value = UtcDateTime.FormatAsIso8601Value(this.Value.Value, DateTimeType.DateAndTime);
            } else {
                value = string.Empty;
            }
            return value;
        ...
        internal override void LoadValueFromDbDataReader(DbDataReader dataReader, int ordinal) {
            if (dataReader.IsDBNull(ordinal)) {
                ...
                this.valueFromDbDataReader = new DateTime(dataReader.GetInt64(ordinal), DateTimeKind.Utc);
            }
            return;
        }
        ...
        /// </summary>
        /// <param name="value">new value to be set (UTC)</param>
        ...
        public override bool TrySetValueAsString(string value) {
            ...
            if (string.IsNullOrEmpty(value)) {
                ...
                success = UtcDateTime.TryParse(value, out DateTime parsedValue);
                if (success) {
        ...
        protected override bool ValuesAreDifferent(DateTime? x, DateTime? y) {
            return !x.Equals(y);
        }
