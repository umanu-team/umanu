...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// Wrapper class for a field of type bool to be stored in
    /// persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForBool : PersistentFieldForStruct<bool> {
        ...
        public PersistentFieldForBool(string key)
            : base(key) {
            // nothing to do
        }
        ...
        public PersistentFieldForBool(string key, bool value)
            : this(key) {
            this.Value = value;
        }
        ...
        internal override void LoadValueFromDbDataReader(DbDataReader dataReader, int ordinal) {
            if (dataReader.IsDBNull(ordinal)) {
                this.valueFromDbDataReader = default(bool);
            } else {
