...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// Wrapper class for a field of type decimal to be stored in
    /// persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForDecimal : PersistentFieldForStruct<decimal> {
        ...
        public PersistentFieldForDecimal(string key)
            : base(key) {
            // nothing to do
        }
        ...
        public PersistentFieldForDecimal(string key, decimal value)
            : this(key) {
            this.Value = value;
        }
        ...
        internal override void LoadValueFromDbDataReader(DbDataReader dataReader, int ordinal) {
            if (dataReader.IsDBNull(ordinal)) {
                this.valueFromDbDataReader = default(decimal);
            } else {
