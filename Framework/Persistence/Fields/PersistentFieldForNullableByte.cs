...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// Wrapper class for a field of type nullable byte to be stored
    /// in persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForNullableByte : PersistentFieldForElement<byte?> {
        ...
        public PersistentFieldForNullableByte(string key)
            : base(key) {
            // nothing to do
        }
        ...
        public PersistentFieldForNullableByte(string key, byte? value)
            : this(key) {
            this.Value = value;
        }
