...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// Wrapper class for a field of type char to be stored in
    /// persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForChar : PersistentFieldForStruct<char> {
        ...
        public PersistentFieldForChar(string key)
            : base(key) {
            // nothing to do
        }
        ...
        public PersistentFieldForChar(string key, char value)
            : this(key) {
            this.Value = value;
        }
