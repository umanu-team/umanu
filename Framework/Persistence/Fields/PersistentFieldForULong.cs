...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// Wrapper class for a field of type ulong to be stored in
    /// persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForULong : PersistentFieldForStruct<ulong> {
        ...
        public PersistentFieldForULong(string key)
            : base(key) {
            // nothing to do
        }
        ...
        public PersistentFieldForULong(string key, ulong value)
            : this(key) {
            this.Value = value;
        }
        ...
        internal override void LoadValueFromDbDataReader(DbDataReader dataReader, int ordinal) {
            if (dataReader.IsDBNull(ordinal)) {
                this.valueFromDbDataReader = default(ulong);
            } else {
