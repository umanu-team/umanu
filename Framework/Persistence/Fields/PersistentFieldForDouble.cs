...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// Wrapper class for a field of type double to be stored in
    /// persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForDouble : PersistentFieldForStruct<double> {
        ...
        public PersistentFieldForDouble(string key)
            : base(key) {
            // nothing to do
        }
        ...
        public PersistentFieldForDouble(string key, double value)
            : this(key) {
            this.Value = value;
        }
        ...
        internal override void LoadValueFromDbDataReader(DbDataReader dataReader, int ordinal) {
            if (dataReader.IsDBNull(ordinal)) {
                this.valueFromDbDataReader = default(double);
            } else {
