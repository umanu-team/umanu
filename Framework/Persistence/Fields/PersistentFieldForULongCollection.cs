...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// List of objects of type ulong that can be stored in
    /// persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForULongCollection : PersistentFieldForCollection<ulong> {
        ...
        /// </summary>
        private List<ulong> valuesFromDbDataReader;

        /// <summary>
        /// Instantiates a new instance.
        /// </summary>
        /// <param name="key">name of persistent field</param>
        public PersistentFieldForULongCollection(string key)
            : base(key) {
            // nothing to do
        }
        ...
        protected override PersistentFieldForElement<ulong> GetNewPersistentFieldForElement() {
            return new PersistentFieldForULong(this.Key);
        }
        ...
        public override IEnumerable<string> GetValuesAsString() {
            foreach (var uLongValue in this) {
                yield return uLongValue.ToString(CultureInfo.InvariantCulture);
            }
        }
        ...
        internal override void InitializeTemporaryCollectionForDbDataReader() {
            this.valuesFromDbDataReader = new List<ulong>();
            return;
        }
        ...
        internal override void LoadValueFromDbDataReader(DbDataReader dataReader) {
            this.valuesFromDbDataReader.Add(Convert.ToUInt64(dataReader.GetValue(0), CultureInfo.InvariantCulture.NumberFormat));
            return;
        }
        ...
        public override bool TryAddString(string item) {
            bool success = ulong.TryParse(item, NumberStyles.Any, CultureInfo.InvariantCulture, out ulong parsedItem);
            this.Add(parsedItem);
            return success;
        }
