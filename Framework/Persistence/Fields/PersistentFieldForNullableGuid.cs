...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// Wrapper class for a field of type nullable Guid to be stored
    /// in persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForNullableGuid : PersistentFieldForElement<Guid?> {
        ...
        public PersistentFieldForNullableGuid(string key)
            : base(key) {
            // nothing to do
        }
        ...
        public PersistentFieldForNullableGuid(string key, Guid? value)
            : this(key) {
            this.Value = value;
        }
        ...
        protected override bool ValuesAreDifferent(Guid? x, Guid? y) {
            return !x.Equals(y);
        }
