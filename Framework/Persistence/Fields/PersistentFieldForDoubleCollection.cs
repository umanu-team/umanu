...
namespace Framework.Persistence.Fields {
    ...
    /// <summary>
    /// List of objects of type double that can be stored in
    /// persistence mechanism.
    /// </summary>
    public sealed class PersistentFieldForDoubleCollection : PersistentFieldForCollection<double> {
        ...
        /// </summary>
        private List<double> valuesFromDbDataReader;

        /// <summary>
        /// Instantiates a new instance.
        /// </summary>
        /// <param name="key">name of persistent field</param>
        public PersistentFieldForDoubleCollection(string key)
            : base(key) {
            // nothing to do
        }
        ...
        protected override PersistentFieldForElement<double> GetNewPersistentFieldForElement() {
            return new PersistentFieldForDouble(this.Key);
        }
        ...
        public override IEnumerable<string> GetValuesAsString() {
            foreach (var doubleValue in this) {
        ...
        internal override void InitializeTemporaryCollectionForDbDataReader() {
            this.valuesFromDbDataReader = new List<double>();
            return;
        }
        ...
        internal override void LoadValueFromDbDataReader(DbDataReader dataReader) {
            this.valuesFromDbDataReader.Add(dataReader.GetDouble(0));
            return;
        }
        ...
        public override bool TryAddString(string item) {
            bool success = double.TryParse(item, NumberStyles.Any, CultureInfo.InvariantCulture, out double parsedItem);
            this.Add(parsedItem);
            return success;
        }
