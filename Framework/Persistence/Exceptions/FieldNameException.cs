...
namespace Framework.Persistence.Exceptions {
    ...
    /// <summary>
    /// Exception to be thrown if an invalid field name is used.
    /// </summary>
    [Serializable]
    public class FieldNameException : PersistenceException {
        ...
        public FieldNameException(string message, Exception innerException)
