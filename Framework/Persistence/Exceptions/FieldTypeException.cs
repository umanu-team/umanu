...
namespace Framework.Persistence.Exceptions {
    ...
    /// <summary>
    /// Exception to be thrown if a wrong field type is used.
    /// </summary>
    [Serializable]
    public class FieldTypeException : PersistenceException {
        ...
        public FieldTypeException(string message, Exception innerException)
